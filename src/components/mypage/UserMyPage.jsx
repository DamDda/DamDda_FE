...
export const UserMyPage = () => {
    ...
    const renderSelectedTabContent = () => {
        ...
        switch (selectedTab) {
            case 0:
                return <ProfileStatistics profile={profileData} setIsEditing={setIsEditing} />;
            case 1:
                return <SupportedProjects />;
            case 2:
                if (myprojectClick) {
                    return <MyProjectDetails projectId={myprojectId} setMyprojectClick={setMyprojectClick} />;
                } else {
                    return <Myproject setMyprojectId={setMyprojectId} setMyprojectClick={setMyprojectClick} />;
                }
            case 3:
                return <LikeProject />;
            case 4:
