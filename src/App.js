                ...
                <div style={{ fontFamily: 'Pretendard-Regular' }}>
                    <Router>
                        <Routes>
                            ...
                            <Route
                                path="/category"
                                element={<MultiCategoryComponent setCategory={(value) => handleyClick(value)} />}
                            />
                            ...
                            <Route
                                path="/download"
                                element={
                                    <FileDownloadComponent handleDownload={handleFileDownload} fileName="example.pdf" />
                                }
                            />
                            ...
                            <Route path="/gifts" element={<GiftCompositionComponent rewardData={rewardData} />} />

                            <Route
                                path="/carousel"
                                element={<ImageCarousel images={CarouselImages} style={CarouselStyle} />}
                            />
