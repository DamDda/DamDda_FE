...
//                     </IconButton>
//                 </TableCell>
//                 <TableCell style={{ textAlign: 'center' }}>{row.supportingProject.supportingProjectId}</TableCell>
//                 <TableCell style={{ textAlign: 'center' }}>{row.delivery.deliveryName}</TableCell>
...
//                                 <strong style={{ fontSize: '18px', padding: '25px' }}>선물 정보</strong>
//                                 {row.item_name}
//                             </Typography>
//                             <Typography variant="body1">
//                                 <strong style={{ fontSize: '18px', padding: '25px' }}>연락처</strong>
//                                 {row.delivery.deliveryPhoneNumber}
//                             </Typography>
//                             <Typography variant="body1">
//                                 <strong style={{ fontSize: '18px', padding: '25px' }}>배송지 정보</strong>
//                                 {row.delivery.deliveryAddress} {row.delivery.deliveryDetailedAddress}
//                             </Typography>
//                             <Typography variant="body1">
//                                 <strong style={{ fontSize: '18px', padding: '25px' }}>배송 요청 사항</strong>
...
//                             <TableCell>{order.supportingProject.supportingProjectId}</TableCell>
//                             <TableCell>{order.delivery.deliveryName}</TableCell>
//                             <TableCell>{new Date(order.supportingProject.supportedAt).toLocaleString()}</TableCell>
...
// export function MyProjectDetailDashBoard({ projectId }) {
...
//                     <Box mt={5}>
//                         {/* 가짜 데이터 전달 */}
//                         <ProgressChart serverData={chartData || mockChartData} targetFunding={targetFunding} />
//                     </Box>
//                 </>
//             )}
