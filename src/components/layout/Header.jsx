    ...
    return (
        <AppBar position="fixed" sx={{ bgcolor: '#fafafa', boxShadow: 'none' }}>
            <Container maxWidth="1520px" sx={{ width: '80%', margin: '0 auto' }}>
                ...
                >
                    <Link to="/">
                        <img src={logo} alt="logo" style={{ width: '170px', height: '70px', marginLeft: '100px' }} />
                    </Link>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <Box ref={showProjects ? boxRef : null} sx={{ position: 'relative' }}>
                            <BlueButtonComponent
                                text="프로젝트 등록"
                            ...
                            {showProjects && (
                                <WriteProjectBox
                                    ...
                                    handleDeleteProject={(projectId) => handleDeleteProject(projectId)}
                                />
                            )}
                        </Box>

                        <Box ref={showProfileCard ? boxRef : null} sx={{ position: 'relative' }}>
                            {
                                user.id ?
                                    // 로그인 후 프로필 카드
