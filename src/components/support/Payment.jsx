...
import { StyledBlueButtonComponent, BlueButtonComponent } from 'components/common/ButtonComponent';
                ...
                <div className="big-container">
                    <div className="container">
                        ...
                        <div className="order-summary">
                            <p className="package-header">프로젝트 이름: {orderInfo.projectTitle}</p>
                                ...
                                orderInfo.selectedPackages.map((pkg, index) => {
                                    return (
                                        <div key={index}>
                                            ...
                                            <p className="price-info">가격: {pkg.price.toLocaleString()} 원</p>
                                            <p>수량: {pkg.quantity} 개</p>
                                ...
                                >
                                    <FormControlLabel
                                        ...
                                        label={
                                            <>
                                                <span>네이버 페이</span>
                                                <img src={naverpay} alt="네이버페이" className="payment-logo" />
                                            </>
                                        }
                                    />
                                    <FormControlLabel
                                        ...
                                        label={
                                            <>
                                                <span>카카오페이</span>
                                                <img src={kakaopay} alt="카카오페이" className="payment-logo" />
                                            </>
                                        }
                                    />
                                    <FormControlLabel
                                        ...
                                        label={
                                            <>
                                                <span>토스 페이</span>
                                                <img src={tosspay} alt="토스페이" className="payment-logo" />
                                            </>
                                        }
                                    />
                                </RadioGroup>
                    ...
                    <div className="small-container">
                        <div className="payment-summary">
                            ...
                            <BlueButtonComponent onClick={handleSubmit} text="간편 결제 하기" />
                        </div>
                    </div>
                </div>
            </div>
