...
import { StatusButton } from 'components/common/ButtonComponent';
    ...
    return (
        <Box>
            ...
            >
                ...
                >
                    회원 탈퇴 시, 회원님의 모든 개인 정보 및 관련 데이터는 즉시 삭제됩니다. 이로 인해 회원님이 진행
                    중이던 <br /> 모든 프로젝트와 후원 내역이 더 이상 관리되지 않으며, 해당 데이터는 복구할 수 없습니다.{' '}
                    <br />
            ...
            >
                ...
                >
                    ・ 회원 탈퇴 이후에는 로그인 및 사이트 내 서비스 이용이 불가능하며, 탈퇴된 계정은 재사용할 수
                    없습니다. <br />
                    ・ 탈퇴 시 회원님의 후원 내역 및 프로젝트 관리 권한은 삭제되며, 더 이상 수정이나 확인이 불가합니다.
                    <br />
                    ・ 후원이 진행 중인 프로젝트가 있을 경우, 탈퇴 전 반드시 후원 상태를 확인하시기 바랍니다. <br />
                    ・ 진행 중인 펀딩이 있는 경우 환불이 불가할 수 있습니다.
                    <br />・ 탈퇴 후에도 사용자가 올린 프로젝트는 사이트에서 유지될 수 있으며, 이와 관련한 책임은 탈퇴
                    후에도 <br /> <span style={{ display: 'inline-block', marginLeft: '20px' }}></span>
                    사용자에게 남을 수 있습니다.
                    <br />・ 재가입을 원할 경우, 신규 가입 절차를 진행해야 하며, 이전 계정 정보는 복구되지 않습니다.
                </Typography>
            </Box>
            ...
            <FormControlLabel
                ...
                control={<Checkbox checked={checked} onChange={handleCheck} style={{ marginTop: '20px' }} />}
            ...
            <StatusButton
                ...
                sx={{
                    ...
                    border: 'none', // 테두리 없애기
                    '&:hover': {
                        backgroundColor: '#677cf9', // 호버 시 색상 변경 없음
